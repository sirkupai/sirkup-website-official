...
export default function EngineeringPage() {
  ...
  const features = [
    {
      ...
      description: 'Build and ship faster with intelligent automation.',
      image: '/images/engineering-subpage (1).jpg'
    },
    {
  ...
  const stats = [
    { percentage: '75%', description: 'faster development cycles' },
    { percentage: '80%', description: 'reduction in manual testing' },
    { percentage: '3x', description: 'improvement in deployment frequency' }
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <section ref={addSectionRef} className="relative py-20 px-4 md:px-8 text-center opacity-0">
        <div className="max-w-4xl mx-auto">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Solutions for engineering</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-black dark:text-white mb-8 leading-tight">
            Build and ship faster with AI<br />support for coding, testing, and documentation
          </h1>
          <Link 
            href="/contact" 
      ...
      <section ref={addSectionRef} className="py-20 px-4 md:px-8 bg-gray-50 dark:bg-zinc-900 opacity-0">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-normal text-black dark:text-white mb-8">
            Your code and intellectual property are protected
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div>
              ...
              <h3 className="text-lg font-normal text-black dark:text-white mb-2">
                Your codebase remains confidential
              </h3>
            </div>
            <div>
              <div className="mb-4">
