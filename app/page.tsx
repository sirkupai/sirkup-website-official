...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                <div className="relative w-32 md:w-48 h-16 md:h-24">
                  <Image
                    ...
                    alt={partner.name}
                    fill
                    className="object-contain invert opacity-80 hover:opacity-100 transition-opacity"
                  />
                </div>
              </div>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        {/* Blog Cards Section - Explore More with Creative Gradients */}
        <section ref={addSectionRef} className="py-12 md:py-20 opacity-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="aspect-video rounded-xl overflow-hidden relative group cursor-pointer">
                <div className="absolute inset-0 bg-gradient-to-br from-slate-300 via-gray-200 to-stone-300"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute bottom-4 left-4 right-4 text-gray-800 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                  <p className="text-sm font-semibold">Live Demo</p>
                  <p className="text-xs opacity-75">See AI in action</p>
                </div>
              </div>
              <h3 className="font-medium text-gray-900">New in Content Intelligence: December 2024</h3>
            ...
            <div className="space-y-4">
              <div className="aspect-video rounded-xl overflow-hidden relative group cursor-pointer">
                <div className="absolute inset-0 bg-gradient-to-br from-zinc-300 via-neutral-200 to-gray-300"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute bottom-4 left-4 right-4 text-gray-800 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                  <p className="text-sm font-semibold">Success Story</p>
                  <p className="text-xs opacity-75">Real impact delivered</p>
                </div>
              </div>
              <h3 className="font-medium text-gray-900">Conversational AI in Real Estate</h3>
              <div className="flex gap-4 text-xs text-gray-500">
            ...
            <div className="space-y-4">
              <div className="aspect-video rounded-xl overflow-hidden relative group cursor-pointer">
                <div className="absolute inset-0 bg-gradient-to-br from-stone-300 via-gray-200 to-slate-300"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute bottom-4 left-4 right-4 text-gray-800 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                  <p className="text-sm font-semibold">Academy Launch</p>
                  <p className="text-xs opacity-75">Learn & grow</p>
                </div>
              </div>
              <h3 className="font-medium text-gray-900">AI Education Programs Launch</h3>
              <div className="flex gap-4 text-xs text-gray-500">
                <span>Product</span>
                <span className="text-gray-300">•</span>
            ...
            <div className="space-y-4">
              <div className="aspect-video rounded-xl overflow-hidden relative group cursor-pointer">
                <div className="absolute inset-0 bg-gradient-to-br from-gray-300 via-stone-200 to-zinc-300"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute bottom-4 left-4 right-4 text-gray-800 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                  <p className="text-sm font-semibold">Best Practices</p>
                  <p className="text-xs opacity-75">Build better</p>
                </div>
              </div>
              <h3 className="font-medium text-gray-900">Building Production-Ready AI</h3>
              <div className="flex gap-4 text-xs text-gray-500">
                <span>Guide</span>
                <span className="text-gray-300">•</span>
