      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Research Index</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Research Overview</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Research Residency</a></li>
            </ul>
          </div>

          {/* SirkupAI */}
          <div>
            <h3 className="text-sm font-medium text-gray-900 mb-4">SirkupAI</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Explore SirkupAI</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Team</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Enterprise</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Education</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Pricing</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Download ↗</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Business Overview</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Solutions</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Contact Sales</a></li>
            </ul>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Our Charter</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Careers</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Brand</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Other Policies</a></li>
            </ul>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Stories</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Livestreams</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Podcast</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            ...
            <a href="https://discord.com" className="text-gray-400 hover:text-gray-600">
